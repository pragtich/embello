...
\ STM workaround from STM DocID14574 Rev 13
: i2c-SCL-stretch OMODE-OD                 SCL io-mode! SCL ioc! ;
: i2c-SCL-release OMODE-AF-OD OMODE-FAST + SCL io-mode! ;
...
: i2c-xfer ( u -- nak) \ prepares for an nbyte reply. Use after i2c-addr. Stops i2c after completion.
  ...
  i2c-EV6b
	...
	i2c-SCL-stretch          \ Workaround for chip bug
