...
\ SET-NEAR .  Then the F0 variables REL-NEAR (default 1E-12) and
...
0 variable START-DEPTH
0 variable XCURSOR      \ for ...}T
0 variable ERROR-XT
...
HAS-FLOATING [IF]
    ...
    F0 variable REL-NEAR 1E-12 REL-NEAR F!
    F0 variable ABS-NEAR 0E    ABS-NEAR F!
...
HAS-FLOATING-STACK [IF]
    0 variable ACTUAL-FDEPTH
    CREATE ACTUAL-FRESULTS 32 FLOATS ALLOT
    0 variable START-FDEPTH
    0 variable FCURSOR
